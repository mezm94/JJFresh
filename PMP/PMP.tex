...
\chapter*{Executive Summary}
   ...
   The risks of the project have been analyzed, and possible solutions for them are also provided in this report. The technology we choose is Wix, which can help quickly create a website. Since we are a virtual team, the communication process of the project is mainly through video calls by \textit{Zoom}. \textit{Slack} is also used to help us exchange information and resources.
