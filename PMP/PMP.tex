...
Without calculating the features needed in the future, the total number of project story points is 57. The total velocity of the three sprints is 75 story points. In theory, we have enough time to finish all the workS

\subsection{The First Sprint Plan}
As mention in section \ref{sec:sprintCycle}, the main goal of the first sprint is to launch a webpage where customers can browse products. Considering both the BFTB Score, which is shown in table \ref{tab:productBacklog} and the actual development needs, the Sprint Backlog of the first sprint is shown in table \ref{tab:firstSprintBacklog}. The total velocity and the total delivery value of the first sprint is 30 story points and is 25, respectively. 
\\
\begin{tabularx}{\linewidth}{%
  l%
  >{\raggedright\arraybackslash}p{2cm}%
  ...
  \bottomrule
  \\
  \caption{Sprint Backlog(4.27 - 5.8)}  
