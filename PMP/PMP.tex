...
\chapter*{Executive Summary}
   Jess and James plan to get a web-based system for online ordering of their produce box offerings. In this way, they may be able to gain more orders while maintaining their existing customer base. Because Jess and James are self-operated stores and have insufficient budgets, to reduce development costs, the online store would be implemented by a student team from the University of Melbourne.
...
\textit{(1) no impact; (2) minimal impact; (3) moderate impact; (4) severe impact; and (5) catastrophic impact; }

The Risk Impact analysis table is shown in \ref{tab:riskImpactAnalysisTable}.
